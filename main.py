...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        title_label.config(text="Work Mode", bg=YELLOW)
...
#Create Window with canvas to add image
window = tkinter.Tk()
...
#Create Label
title_label = tkinter.Label(text="Timer",bg=YELLOW, font=(FONT_NAME,50), fg=GREEN)
